...
export default function index() {
  return (
    <div className="dark:bg-gray-900 z-[-1]">
      <section className="mx-auto container py-20 ">


        
        <div className="flex justify-center items-center flex-col">
          <div className="lg:text-4xl md:text-3xl text-2xl font-black leading-10 text-center text-gray-800 dark:text-white">
            <h1>Why choose Whitesun Logistics</h1>
          </div>
          <div className="pt-24 grid lg:grid-cols-3 md:grid-cols-2 justify-center items-center xl:gap-y-16 gap-y-20 gap-x-16 lg:gap-x-20 xl:gap-x-0 lg:px-10 xl:px-0">
            <div className="cursor-pointer hover:shadow py-6 xl:px-4 rounded xl:w-96 w-60 flex justify-center items-center flex-col">
              ...
              <div className="text-gray-800 dark:text-white text-2xl font-semibold text-center">
                <h2>Building Supplies Delivered</h2>
              </div>
              <div className="text-gray-600 dark:text-gray-300 mt-2 text-lg text-center ">
                <p> Get all your building materials (stone, bricks, timber etc.) delivered directly to your site.</p>
              </div>
            </div>
            <div className="cursor-pointer hover:shadow py-6 xl:px-4 rounded xl:w-96 w-60 flex justify-center items-center flex-col">
              <div className="mb-6">
              ...
              <div className="text-gray-800 dark:text-white text-2xl font-semibold text-center">
                <h2>Logistics Experts</h2>
              </div>
              <div className="text-gray-600 dark:text-gray-300 mt-2 text-lg text-center">
                <p>From domestic trucking to international shipping, Whitesun handles all your freight needs.</p>
              </div>
            </div>
            <div className="cursor-pointer hover:shadow py-6 xl:px-4 rounded xl:w-96 w-60 flex justify-center items-center flex-col">
              <div className="mb-6">
              ...
              <div className="text-gray-600 dark:text-gray-300 mt-2 text-lg text-center">
                <p>Keep your belongings safe with Whitesun's advanced warehousing and 24/7 security.</p>
              </div>
            </div>
            <div className="cursor-pointer hover:shadow py-6 xl:px-4 rounded xl:w-96 w-60 flex justify-center items-center flex-col">
              <div className="mb-6">
              ...
              <div className="text-gray-800 dark:text-white text-2xl font-semibold text-center">
                <h2>Seamless Moving Services</h2>
              </div>
              <div className="text-gray-600 dark:text-gray-300 mt-2 text-lg text-center">
                <p> Whether it's your home or office, Whitesun offers packing, storage, and moving solutions.</p>
              </div>
            </div>
            <div className="cursor-pointer hover:shadow py-6 xl:px-4 rounded xl:w-96 w-60 flex justify-center items-center flex-col">
              <div className="mb-6">
              ...
              <div className="text-gray-800 dark:text-white text-2xl font-semibold text-center">
                <h2>Short or Long Term Storage</h2>
              </div>
              <div className="text-gray-600 dark:text-gray-300 mt-2 text-lg text-center">
                <p>Need temporary storage during a move? Or long-term for equipment? Whitesun has you covered</p>
              </div>
            </div>
            <div className="cursor-pointer hover:shadow py-6 xl:px-4 rounded xl:w-96 w-60 flex justify-center items-center flex-col">
              <div className="mb-6">
              ...
              <div className="text-gray-800 dark:text-white text-2xl font-semibold text-center">
                <h2>Kenya's Trusted Partner</h2>
              </div>
              <div className="text-gray-600 dark:text-gray-300 mt-2 text-lg text-center">
                <p>Whitesun Logistics, a leader in Kenyan building materials, freight, and storage solutions.</p>
              </div>
            </div>
          </div>
        </div>
