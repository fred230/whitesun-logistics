...
const Faq1 = () => {
    ...
    return (
        <div className=" w-11/12 2xl:mx-auto md:py-12 lg:px-16 md:px-6 py-9 px-4">
            ...
            <div className=" flex md:flex-row flex-col md:space-x-8 md:mt-16 mt-8">
                <div className=" md:w-5/12 lg:w-4/12 w-full ">
                    <img src="https://images.unsplash.com/photo-1613690399151-65ea69478674?q=80&w=1773&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Img of Glass bottle" className="w-full md:block hidden" />
                    <img src="https://images.unsplash.com/photo-1613690399151-65ea69478674?q=80&w=1773&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Img of Glass bottle" className="w-full md:hidden block " />
                </div>
