...
const Contact
 = () => {
  return (
    <div className="flex justify-center p-16 items-center  w-screen min-h-screen bg-white">
	
	<div className="container mx-auto my-4 px-4 lg:px-20">

		<div className="w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
			<div className="flex text-[#020c52]">
				<h1 className="font-bold uppercase text-4xl">Send us a <br /> message</h1>
			</div>
            ...
            type="number" placeholder="Phone*" />
				...
				<div className="my-2 w-1/2 lg:w-1/4">
					<button className="uppercase text-sm font-bold tracking-wide bg-[#020c52] text-gray-100 p-3 rounded-lg w-full 
			...
			<div
				className="w-full lg:-mt-96 lg:w-2/6 px-8 py-12 ml-auto bg-[#020c52] rounded-2xl">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-gray-400">Mamlaka RD, Shelter Afrique, Suite 5</p>
            </div>
          </div>
          ...
          <div className="flex my-4 w-2/3 lg:w-1/2">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-gray-400">Tel: +254-157-988-43</p>
